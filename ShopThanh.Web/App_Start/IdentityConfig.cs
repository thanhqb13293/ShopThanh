...
namespace ShopThanh.Web.App_Start
{
    public class ApplicationUserStore : UserStore<ApplicationUser>
    {
        public ApplicationUserStore(ShopThanhDbContext store)
            : base(store)
        {
        }
    }
        ...
        public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<ShopThanhDbContext>()));
